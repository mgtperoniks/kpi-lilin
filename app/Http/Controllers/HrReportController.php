...
class HrReportController extends Controller
{
    ...
    public function create()
    {
        ...
        // Branded Lilin format: HR/KPI-lilin/MM/NNN
        $reportNumber = sprintf('HR/KPI-lilin/%s/%03d', $now->format('m'), $nextNumber);
    ...
    public function store(Request $request)
    {
        ...
        return DB::transaction(function() use ($validated, $request) {
            ...
            // Branded Lilin format: HR/KPI-lilin/MM/NNN
            $validated['report_number'] = sprintf('HR/KPI-lilin/%s/%03d', $now->format('m'), $nextNumber);
