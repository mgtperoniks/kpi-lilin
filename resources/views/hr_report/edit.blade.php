        ...
        <form action="{{ route('hr_report.update', $report->id) }}" method="POST" enctype="multipart/form-data" id="editReportForm">
            ...
            <div class="mb-4 p-4 bg-blue-50 border border-blue-100 rounded-2xl flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-blue-600 leading-tight">Progress laporan and pengajuan workflow dikelola langsung melalui halaman <b>Detail Laporan</b>.</p>
                </div>
            </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="url" name="data_link" required value="{{ $report->data_link }}" placeholder="http://10.88.8.97/kpi-lilin/public/daily-report/operator/show/..."
