        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-green-50: oklch(.979 .021 166.113);
                    --color-green-100: oklch(.95 .052 163.051);
                    --color-green-200: oklch(.905 .093 164.15);
                    --color-green-300: oklch(.845 .143 164.978);
                    --color-green-400: oklch(.765 .177 163.223);
                    --color-green-500: oklch(.696 .17 162.48);
                    --color-green-600: oklch(.596 .145 163.225);
                    --color-green-700: oklch(.508 .118 165.612);
                    --color-green-800: oklch(.432 .095 166.913);
                    --color-green-900: oklch(.378 .077 168.94);
                    --color-green-950: oklch(.262 .051 172.552);
                    --color-green-50: oklch(.984 .014 180.72);
                    --color-green-100: oklch(.953 .051 180.801);
                    --color-green-200: oklch(.91 .096 180.426);
                    --color-green-300: oklch(.855 .138 181.071);
                    --color-green-400: oklch(.777 .152 181.912);
                    --color-green-500: oklch(.704 .14 182.503);
                    --color-green-600: oklch(.6 .118 184.704);
                    --color-green-700: oklch(.511 .096 186.391);
                    --color-green-800: oklch(.437 .078 188.216);
                    --color-green-900: oklch(.386 .063 188.416);
                    --color-green-950: oklch(.277 .046 192.524);
                    ...
                    --color-green-50: oklch(.97 .014 254.604);
                    --color-green-100: oklch(.932 .032 255.585);
                    --color-green-200: oklch(.882 .059 254.128);
                    --color-green-300: oklch(.809 .105 251.813);
                    --color-green-400: oklch(.707 .165 254.624);
                    --color-green-500: oklch(.623 .214 259.815);
                    --color-green-600: oklch(.546 .245 262.881);
                    --color-green-700: oklch(.488 .243 264.376);
                    --color-green-800: oklch(.424 .199 265.638);
                    --color-green-900: oklch(.379 .146 265.522);
                    --color-green-950: oklch(.282 .091 267.935);
